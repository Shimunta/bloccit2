...
RSpec.describe QuestionsController, type: :controller do
  let(:my_question) {Question.create!(title: "A Question?", body: "An Explanation?", resolved: false) }
  ...
  describe "GET new" do
    ...
    it "instantiates new question object" do
      get :new
  ...
  describe "PUT update" do
    it "updates the expected attribute" do
      new_title = "New Title"
      new_body = "New Body"
    ...
    it "redirects to the updated new question" do
      new_title = "New Title"
      new_body = "New Body"
